    ...
    <div className="sponsors" ref={ref}>
      ...
      <div className="sponsor-list">
        ...
        <div className="gold-sponsors">
          <a
            ...
            <p className="sponsor-description">
              A private school with public purpose, Lick-Wilmerding High School
              develops the head, heart, and hands of highly motivated students
              from all walks of life, inspiring them to become lifelong learners
              who contribute to the world with confidence and compassion.
            </p>
          </a>
          {SponsorData.filter((sponsor) => sponsor.tier === "Gold").map(
            (sponsor, index) => (
        ...
        <div className="silver-sponsors">
          {SponsorData.filter((sponsor) => sponsor.tier === "Silver").map(
            (sponsor, index) => (
        ...
        <div className="bronze-sponsors">
          {SponsorData.filter((sponsor) => sponsor.tier === "Bronze").map(
            (sponsor, index) => (
      ...
      <div className="sponsorship-prospectus">
        <div className="why-sponsor">
          ...
          <p className="sponsors-description">
            Hyphen-Hacks is entirely student-organized and dedicated to making
            tech more inclusive and accessible. We welcome participants of all
            experience levels and backgrounds, and we design our event to lower
            the barrier to entry into STEM. Sponsoring Hyphen-Hacks is an
            opportunity to support the next generation of innovators, coders,
            and creative problem-solvers. As a sponsor, your organization will
            connect with high school students early in their tech journeys and
            gain visibility through on-site, digital, and merch branding. Your
            involvement signals a commitment to educational equity, youth
            empowerment, and a more diverse future in tech. With your support,
            we can continue to provide a free, impactful experience for Bay Area
            students passionate about the technical arts!
          </p>
        </div>
